...
export const SETTINGS_TRANSLATIONS = {
    en: {
        ...
        stopEarlySummaryWordsFmt: 'Type {count} words · unlock {duration}',
        stopEarlySummaryCustomFmt: 'Custom text · unlock {duration}',
        unlockDuration: 'Temporary unlock duration',
        unlockDurationDesc: 'How long blocking is lifted when you stop this focus space. It turns itself back on afterwards.',
        unlock_0: 'Never',
        unlock_5: '5 minutes',
    ...
    da: {
        ...
        stopEarlySummaryWordsFmt: 'Skriv {count} ord · lås op {duration}',
        stopEarlySummaryCustomFmt: 'Egen tekst · lås op {duration}',
        unlockDuration: 'Midlertidig oplåsning',
        unlockDurationDesc: 'Hvor længe blokeringen er ophævet, når du stopper dette fokusrum. Det slår sig selv til igen bagefter.',
        unlock_0: 'Aldrig',
        unlock_5: '5 minutter',
    ...
    'zh-CN': {
        ...
        toStopEarly: '提前停止',
        stopEarlySummaryWordsFmt: '输入 {count} 个词 · 解锁 {duration}',
        stopEarlySummaryCustomFmt: '自定义文本 · 解锁 {duration}',
        unlockDuration: '临时解锁时长',
        unlockDurationDesc: '停止此专注空间后阻止会解除多久。之后它会自动重新开启。',
        unlock_0: '从不',
        unlock_5: '5 分钟',
        unlock_10: '10 分钟',
        unlock_15: '15 分钟',
