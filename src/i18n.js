...
export const SETTINGS_TRANSLATIONS = {
    en: {
        ...
        maxOverrideWordsHint: 'How far the "Words to type" slider goes in each focus space. Lowering it never shortens a challenge you have already set.',
        ...
        whatToBlockSummaryFmt: '{websites} websites · {apps} apps',
        ...
        untilLabel: 'Until',
        untilWhenIStop: 'When I stop it',
        untilDate: 'Date',
        untilDateSummaryFmt: 'until {date}',
        toStopEarly: 'To stop early',
        stopEarlySummaryWordsFmt: 'Type {count} words · auto-start after {duration}',
        stopEarlySummaryCustomFmt: 'Custom text · auto-start after {duration}',
        stopEarlySummaryWordsNeverFmt: 'Type {count} words · no auto-start',
        stopEarlySummaryCustomNever: 'Custom text · no auto-start',
        unlockDuration: 'Auto-start after stop',
        unlockDurationDesc: 'When you stop this focus space, it turns itself back on after this long. Never keeps it off until you turn it on again.',
        unlock_0: 'Never',
        unlock_5: '5 minutes',
    ...
    da: {
        ...
        maxOverrideWordsHint: 'Hvor langt skyderen "Ord at taste" går i hvert fokusrum. At sænke den forkorter aldrig en udfordring, du allerede har sat.',
        ...
        whatToBlockSummaryFmt: '{websites} hjemmesider · {apps} apps',
        ...
        stopEarlySummaryWordsFmt: 'Skriv {count} ord · autostart efter {duration}',
        stopEarlySummaryCustomFmt: 'Egen tekst · autostart efter {duration}',
        stopEarlySummaryWordsNeverFmt: 'Skriv {count} ord · ingen autostart',
        stopEarlySummaryCustomNever: 'Egen tekst · ingen autostart',
        unlockDuration: 'Autostart efter stop',
        unlockDurationDesc: 'Når du stopper dette fokusrum, slår det sig selv til igen efter så lang tid. Aldrig holder det slået fra, indtil du slår det til igen.',
        unlock_0: 'Aldrig',
        unlock_5: '5 minutter',
    ...
    'zh-CN': {
        ...
        maxOverrideWordsHint: '每个专注空间中“需要输入的词数”滑块的上限。调低它不会缩短你已设置的挑战。',
        ...
        whatToBlock: '屏蔽内容',
        whatToAllow: '允许内容',
        whatToBlockSummaryFmt: '{websites} 个网站 · {apps} 个应用',
        whenToBlock: '屏蔽时间',
        whenDaily: '每天',
        whenWeekly: '每周',
        whenManual: '手动',
        ...
        whenWeeklySummaryFmt: '{days} · {range}',
        untilLabel: '直到',
        untilWhenIStop: '我停止为止',
        untilDate: '日期',
        untilDateSummaryFmt: '直到 {date}',
        toStopEarly: '提前停止',
        stopEarlySummaryWordsFmt: '输入 {count} 个词 · {duration}后自动开启',
        stopEarlySummaryCustomFmt: '自定义文本 · {duration}后自动开启',
        stopEarlySummaryWordsNeverFmt: '输入 {count} 个词 · 不自动开启',
        stopEarlySummaryCustomNever: '自定义文本 · 不自动开启',
        unlockDuration: '停止后自动开启',
        unlockDurationDesc: '停止此专注空间后，经过这段时间会自动重新开启。选择“从不”则保持关闭，直到你再次开启。',
        unlock_0: '从不',
        unlock_5: '5 分钟',
        unlock_10: '10 分钟',
        unlock_15: '15 分钟',
