...
export const SETTINGS_TRANSLATIONS = {
    en: {
        ...
        maxOverrideWordsLabel: 'Maximum words to stop early',
        maxOverrideWordsHint: 'How far the "How many words" slider goes in each focus space. Lowering it never shortens a challenge you have already set.',
        ...
        nothingWord: 'nothing',
        noItems: 'No items',
        noBlocklistsYet: 'No focus spaces yet',
        ...
        scheduleStrictnessLabel: 'Editing',
        allowEditsFlexibleLabel: 'Any change',
        allowEditsFlexibleDesc: 'You can also remove things or turn the schedule off, but only while it isn\'t blocking.',
        allowEditsFlexibleDescAllow: 'You can also allow more things or turn the schedule off, but only while it isn\'t blocking.',
        allowEditsStrictLabel: 'Stricter only',
        allowEditsStrictDesc: 'You can add websites, apps and times, but not remove them. To loosen it, you have to stop the focus space.',
        allowEditsStrictDescAllow: 'You can remove allowed websites and apps, and add times, but not the reverse. To loosen it, you have to stop the focus space.',
        allowEditsBetweenBlocksLockedTooltip: 'Turn the focus space off to change this setting.',
        ...
        focusSpaceName: 'Focus space name',
        whatToBlock: 'What to block',
        whatToAllow: 'What to allow',
        whatToBlockSummaryFmt: '{websites} · {apps}',
        countWebsiteOne: '1 website',
        countWebsitesFmt: '{count} websites',
        countAppOne: '1 app',
        countAppsFmt: '{count} apps',
        whenToBlock: 'When to block',
        whenDaily: 'Daily',
        whenWeekly: 'Weekly',
        whenManual: 'Manual',
        whenManualSummary: 'Manual · starts when enabled',
        whenManualShort: 'Manual',
        whenManualHint: 'Starts when you turn it on and runs until you stop it.',
        whenDailySummaryFmt: 'Daily {range}',
        whenWeeklySummaryFmt: '{days} · {range}',
        untilLabel: 'Until',
        untilWhenIStop: 'I stop it',
        untilDate: 'Date',
        untilDateSummaryFmt: 'until {date}',
        toStopEarly: 'To stop early',
        stopEarlySummaryWordsFmt: 'Type {count} words · back on after {duration}',
        stopEarlySummaryCustomFmt: 'Custom text · back on after {duration}',
        stopEarlySummaryWordsNeverFmt: 'Type {count} words · stays off',
        stopEarlySummaryCustomNever: 'Custom text · stays off',
        unlockDuration: 'Turn back on after',
        unlockDurationDesc: 'If you stop this focus space early, it switches itself back on after this long. Choose "Never" to keep it off until you turn it on yourself.',
        unlock_0: 'Never',
        unlock_5: '5 minutes',
        unlock_10: '10 minutes',
        unlock_15: '15 minutes',
        unlock_30: '30 minutes',
        unlock_60: '1 hour',
        unlock_120: '2 hours',
        unlock_240: '4 hours',
        unlock_480: '8 hours',
        unlock_1440: '24 hours',
        startConfirmSubtitleManual: 'This focus space starts now and runs until you stop it.',
        startConfirmSubtitleSchedule: 'This focus space will block at these times from now on.',
        startConfirmDurationManual: 'Until you stop it',
        startConfirmUnlockLabel: 'If turned off',
        startConfirmUnlockLineFmt: 'Back on after {duration} · <span class="start-confirm-duration-meta">change under To stop early</span>',
        startConfirmUnlockNever: 'Stays off until you turn it on again',
        discardChangesTitle: 'Discard changes?',
        discardChangesBody: 'You have unsaved changes to this focus space. Discard them?',
        discardChangesOk: 'Discard',
        discardChangesCancel: 'Keep editing',
        cardStatusBlockingNow: 'Blocking now',
        cardStatusAllowingNow: 'Allowing now',
        cardStatusScheduled: 'Scheduled',
        cardStatusOff: 'Off',
        cardStatusPausedUntilFmt: 'Paused until {time}',
        cardStatusPausedUntilTomorrowFmt: 'Paused until {time} tomorrow',
        cardStatusLineFmt: '{status} · {timing}',
        ...
        allowlistScopeWebsitesActiveOneHtml: 'All websites are blocked except <strong>this one</strong>.',
        allowlistScopeAppsActiveOneHtml: 'All apps are blocked except <strong>this one</strong>.',
        ...
        overrideMethod: 'What to type',
        overrideWordsEstimateFmt: '{count} · ~{minutes} min',
        overrideWordsToType: 'How many words',
        overrideRandomWords: 'Random Words',
        overrideCustomText: 'Custom Text',
        customOverrideEmptyError: 'Custom message cannot be empty.',
        placeholderCustomOverride: 'e.g., a motivational statement',
        totalCharacters: 'total characters',
        totalWords: 'total words',
        color: 'Colour',
        emoji: 'Emoji',
        advancedOptions: 'Advanced options',
        listBlockedOnCard: 'Show what it blocks on the card',
        listAllowedOnCard: 'Show what it allows on the card',
        ...
        modalBrowseAppsCaption: 'Add App',
        ...
        stopScheduleInactiveSubtitle: 'No scheduled block is active right now.',
        stopResumesAfterFmt: 'Blocking resumes automatically after {duration}.',
        stopResumesAllowAfterFmt: 'Allow only resumes automatically after {duration}.',
        stopStaysOff: 'It stays off until you turn it on again.',
        stopBlock: 'Stop',
        ...
        allowlistIosDomainLimit: 'Your focus spaces allow {n} websites between them, but iOS only supports up to 50 allowed websites at once.',
        allowlistIosDomainLimitTitle: 'Too many allowed websites',
        allowlistIosTokenLimit: 'Your focus spaces allow {n} apps between them, but iOS only supports up to 50 allowed apps at once.',
    ...
    da: {
        ...
        blocklistEnteringChip: 'Redigerer',
        ...
        maxOverrideWordsLabel: 'Maksimalt antal ord for at stoppe før tid',
        maxOverrideWordsHint: 'Hvor langt skyderen "Hvor mange ord" går i hvert fokusrum. At sænke den forkorter aldrig en udfordring, du allerede har sat.',
        ...
        noBlocklistsYet: 'Ingen fokusrum endnu',
        clickHereCreateBlocklist: 'Klik her for at oprette et',
        typeHere: 'Skriv her...',
        ...
        scheduleStrictnessLabel: 'Redigering',
        allowEditsFlexibleLabel: 'Alle ændringer',
        allowEditsFlexibleDesc: 'Du kan også fjerne ting eller slå skemaet fra, men kun når det ikke blokerer.',
        allowEditsFlexibleDescAllow: 'Du kan også tillade flere ting eller slå skemaet fra, men kun når det ikke blokerer.',
        allowEditsStrictLabel: 'Kun strengere',
        allowEditsStrictDesc: 'Du kan tilføje hjemmesider, apps og tidspunkter, men ikke fjerne dem. Vil du løsne det, skal du stoppe fokusrummet.',
        allowEditsStrictDescAllow: 'Du kan fjerne tilladte hjemmesider og apps og tilføje tidspunkter, men ikke omvendt. Vil du løsne det, skal du stoppe fokusrummet.',
        allowEditsBetweenBlocksLockedTooltip: 'Slå fokusrummet fra for at ændre denne indstilling.',
        ...
        focusSpaceName: 'Navn på fokusrum',
        whatToBlock: 'Hvad skal blokeres',
        whatToAllow: 'Hvad skal tillades',
        whatToBlockSummaryFmt: '{websites} · {apps}',
        countWebsiteOne: '1 hjemmeside',
        countWebsitesFmt: '{count} hjemmesider',
        countAppOne: '1 app',
        countAppsFmt: '{count} apps',
        whenToBlock: 'Hvornår skal der blokeres',
        whenDaily: 'Dagligt',
        whenWeekly: 'Ugentligt',
        whenManual: 'Manuelt',
        whenManualSummary: 'Manuelt · starter når du slår det til',
        whenManualShort: 'Manuelt',
        whenManualHint: 'Starter når du slår det til og kører, indtil du stopper det.',
        whenDailySummaryFmt: 'Dagligt {range}',
        whenWeeklySummaryFmt: '{days} · {range}',
        untilLabel: 'Indtil',
        untilWhenIStop: 'Jeg stopper det',
        untilDate: 'Dato',
        untilDateSummaryFmt: 'indtil {date}',
        toStopEarly: 'For at stoppe før tid',
        stopEarlySummaryWordsFmt: 'Skriv {count} ord · slår til igen efter {duration}',
        stopEarlySummaryCustomFmt: 'Egen tekst · slår til igen efter {duration}',
        stopEarlySummaryWordsNeverFmt: 'Skriv {count} ord · forbliver slået fra',
        stopEarlySummaryCustomNever: 'Egen tekst · forbliver slået fra',
        unlockDuration: 'Slå til igen efter',
        unlockDurationDesc: 'Hvis du stopper dette fokusrum før tid, slår det sig selv til igen efter så lang tid. Vælg "Aldrig" for at holde det slået fra, indtil du selv slår det til.',
        unlock_0: 'Aldrig',
        unlock_5: '5 minutter',
        unlock_10: '10 minutter',
        unlock_15: '15 minutter',
        unlock_30: '30 minutter',
        unlock_60: '1 time',
        unlock_120: '2 timer',
        unlock_240: '4 timer',
        unlock_480: '8 timer',
        unlock_1440: '24 timer',
        startConfirmSubtitleManual: 'Dette fokusrum starter nu og kører, indtil du stopper det.',
        startConfirmSubtitleSchedule: 'Dette fokusrum blokerer fremover på disse tidspunkter.',
        startConfirmDurationManual: 'Indtil du stopper det',
        startConfirmUnlockLabel: 'Hvis det slås fra',
        startConfirmUnlockLineFmt: 'Slås til igen efter {duration} · <span class="start-confirm-duration-meta">ændres under Sådan stopper du tidligt</span>',
        startConfirmUnlockNever: 'Forbliver slået fra, indtil du slår det til igen',
        discardChangesTitle: 'Kassér ændringer?',
        discardChangesBody: 'Du har ugemte ændringer i dette fokusrum. Vil du kassere dem?',
        discardChangesOk: 'Kassér',
        discardChangesCancel: 'Fortsæt redigering',
        cardStatusBlockingNow: 'Blokerer nu',
        cardStatusAllowingNow: 'Tillader nu',
        cardStatusScheduled: 'Planlagt',
        cardStatusOff: 'Fra',
        cardStatusPausedUntilFmt: 'På pause indtil {time}',
        cardStatusPausedUntilTomorrowFmt: 'På pause indtil i morgen kl. {time}',
        cardStatusLineFmt: '{status} · {timing}',
        ...
        allowlistScopeWebsitesActiveOneHtml: 'Alle hjemmesider er blokeret undtagen <strong>denne ene</strong>.',
        ...
        overrideMethod: 'Hvad skal tastes',
        overrideWordsEstimateFmt: '{count} · ~{minutes} min',
        overrideWordsToType: 'Hvor mange ord',
        overrideRandomWords: 'Tilfældige ord',
        overrideCustomText: 'Egen tekst',
        customOverrideEmptyError: 'Egen besked må ikke være tom.',
        placeholderCustomOverride: 'f.eks. en motiverende sætning',
        totalCharacters: 'tegn i alt',
        totalWords: 'ord i alt',
        color: 'Farve',
        emoji: 'Emoji',
        advancedOptions: 'Avancerede indstillinger',
        listBlockedOnCard: 'Vis hvad den blokerer på kortet',
        listAllowedOnCard: 'Vis hvad den tillader på kortet',
        ...
        modalBrowseAppsCaption: 'Tilføj app',
        ...
        stopScheduleInactiveSubtitle: 'Ingen planlagt blokering er aktiv lige nu.',
        stopResumesAfterFmt: 'Blokeringen genoptages automatisk efter {duration}.',
        stopResumesAllowAfterFmt: 'Tillad kun genoptages automatisk efter {duration}.',
        stopStaysOff: 'Det forbliver slået fra, indtil du slår det til igen.',
        stopBlock: 'Stop',
        ...
        allowlistIosDomainLimit: 'Dine fokusrum tillader tilsammen {n} hjemmesider, men iOS understøtter kun op til 50 tilladte hjemmesider ad gangen.',
        allowlistIosDomainLimitTitle: 'For mange tilladte hjemmesider',
        allowlistIosTokenLimit: 'Dine fokusrum tillader tilsammen {n} apps, men iOS understøtter kun op til 50 tilladte apps ad gangen.',
    ...
    'zh-CN': {
        ...
        enforcerClosedCombinedMissing: '{browser} 已关闭，因为缺少 Digital Habits: Focus。',
        enforcerClosedCombinedDisabled: '{browser} 已关闭，因为 Digital Habits: Focus 被禁用。',
        enforcerClosedCombinedPrivate: '{browser} 已关闭，因为隐私窗口未受保护。',
        enforcerClosedCombinedWebsiteAccess: '{browser} 已关闭，因为 Digital Habits: Focus 无法访问所有网站。',
        enforcerClosedCombinedAccess: '{browser} 已关闭，因为权限被撤销。',
        enforcerClosedCombinedDefault: '{browser} 已关闭，因为阻止设置不完整。',
        ...
        enforcerClosedInstrDefault: '请在 {browser} 的扩展设置中完成 Digital Habits: Focus 的设置。',
        ...
        enforcerClosedInstrAutomation: '请在 macOS 自动化设置中为 {browser} 重新允许 Digital Habits: Blocker。',
        enforcerClosedCombinedAutomation: '{browser} 已关闭，因为自动化权限被关闭。',
        enforcerClosedInstrAutomationGeneric: '请在 macOS 自动化设置中为 {browser} 重新允许 Digital Habits: Blocker。',
        enforcerBrowserFallback: '浏览器',
        gracePeriodLabel: '宽限时间',
        gracePeriodHint: '浏览器关闭前重新启用的秒数。',
        maxOverrideWordsLabel: '提前停止的最大词数',
        maxOverrideWordsHint: '每个专注空间中“输入多少个词”滑块的上限。调低它不会缩短你已设置的挑战。',
        ...
        exportBlocklistsSuccessFmt: '已导出 {n} 个专注空间及其日程到 {path}。',
        ...
        importBlocklistsConfirmFmt: '将导入 {n} 个专注空间。现有同名专注空间会保留。',
        importBlocklistsSuccessFmt: '已导入 {n} 个专注空间。',
        ...
        scheduleStrictnessLabel: '编辑',
        allowEditsFlexibleLabel: '任意更改',
        allowEditsFlexibleDesc: '你也可以移除项目或关闭日程，但仅限未在阻止时。',
        allowEditsFlexibleDescAllow: '你也可以允许更多项目或关闭日程，但仅限未在阻止时。',
        allowEditsStrictLabel: '只能更严格',
        allowEditsStrictDesc: '你可以添加网站、应用和时间段，但不能移除。要放宽限制，必须先停止此专注空间。',
        allowEditsStrictDescAllow: '你可以移除已允许的网站和应用，也可以添加时间段，但不能反向操作。要放宽限制，必须先停止此专注空间。',
        allowEditsBetweenBlocksLockedTooltip: '关闭此专注空间后才能更改此设置。',
        ...
        focusSpaceName: '专注空间名称',
        whatToBlock: '屏蔽内容',
        whatToAllow: '允许内容',
        whatToBlockSummaryFmt: '{websites} · {apps}',
        countWebsiteOne: '1 个网站',
        countWebsitesFmt: '{count} 个网站',
        countAppOne: '1 个应用',
        countAppsFmt: '{count} 个应用',
        whenToBlock: '屏蔽时间',
        whenDaily: '每天',
        whenWeekly: '每周',
        whenManual: '手动',
        whenManualSummary: '手动 · 启用时开始',
        whenManualShort: '手动',
        whenManualHint: '打开时开始，直到你停止为止。',
        whenDailySummaryFmt: '每天 {range}',
        whenWeeklySummaryFmt: '{days} · {range}',
        untilLabel: '直到',
        untilWhenIStop: '我停止',
        untilDate: '日期',
        untilDateSummaryFmt: '直到 {date}',
        toStopEarly: '提前停止',
        stopEarlySummaryWordsFmt: '输入 {count} 个词 · {duration}后重新开启',
        stopEarlySummaryCustomFmt: '自定义文本 · {duration}后重新开启',
        stopEarlySummaryWordsNeverFmt: '输入 {count} 个词 · 保持关闭',
        stopEarlySummaryCustomNever: '自定义文本 · 保持关闭',
        unlockDuration: '多久后重新开启',
        unlockDurationDesc: '如果你提前停止此专注空间，它会在这段时间后自动重新开启。选择“从不”则保持关闭，直到你自己开启。',
        unlock_0: '从不',
        unlock_5: '5 分钟',
        unlock_10: '10 分钟',
        unlock_15: '15 分钟',
        ...
        unlock_480: '8 小时',
        unlock_1440: '24 小时',
        startConfirmSubtitleManual: '此专注空间现在开始，直到你停止为止。',
        startConfirmSubtitleSchedule: '此专注空间从现在起会在以下时间阻止。',
        startConfirmDurationManual: '直到你停止',
        startConfirmUnlockLabel: '如果关闭',
        startConfirmUnlockLineFmt: '{duration} 后自动重新开启 · <span class="start-confirm-duration-meta">可在“提前停止”中更改</span>',
        startConfirmUnlockNever: '保持关闭，直到你再次打开',
        discardChangesTitle: '放弃更改？',
        discardChangesBody: '此专注空间有未保存的更改。要放弃吗？',
        discardChangesOk: '放弃',
        discardChangesCancel: '继续编辑',
        cardStatusBlockingNow: '正在阻止',
        cardStatusAllowingNow: '正在允许',
        cardStatusScheduled: '已计划',
        cardStatusOff: '已关闭',
        cardStatusPausedUntilFmt: '暂停至 {time}',
        cardStatusPausedUntilTomorrowFmt: '暂停至明天 {time}',
        cardStatusLineFmt: '{status} · {timing}',
        ...
        allowlistScopeWebsitesActiveOneHtml: '除<strong>这一个</strong>外，其他网站均被屏蔽。',
        ...
        overrideMethod: '输入内容',
        overrideWordsEstimateFmt: '{count} · 约 {minutes} 分钟',
        overrideWordsToType: '输入多少个词',
        overrideRandomWords: '随机单词',
        overrideCustomText: '自定义文本',
        customOverrideEmptyError: '自定义消息不能为空。',
        placeholderCustomOverride: '例如：一句激励自己的话',
        totalCharacters: '总字符数',
        totalWords: '总词数',
        color: '颜色',
        emoji: 'Emoji',
        advancedOptions: '高级选项',
        listBlockedOnCard: '在卡片上显示阻止的内容',
        listAllowedOnCard: '在卡片上显示允许的内容',
        ...
        stopScheduleInactiveSubtitle: '当前没有正在运行的计划阻止。',
        stopResumesAfterFmt: '阻止会在 {duration} 后自动恢复。',
        stopResumesAllowAfterFmt: '仅允许会在 {duration} 后自动恢复。',
        stopStaysOff: '它会保持关闭，直到你再次打开。',
        stopBlock: '停止',
        stopSchedule: '停止日程',
        ...
        allowlistIosDomainLimit: '你的专注空间总共允许 {n} 个网站，但 iOS 同时最多只支持 50 个允许的网站。',
        allowlistIosDomainLimitTitle: '允许的网站过多',
        allowlistIosTokenLimit: '你的专注空间总共允许 {n} 个应用，但 iOS 同时最多只支持 50 个允许的应用。',
